...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContactFormContent'
        db.create_table('page_page_contactformcontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contactformcontent_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('page', ['ContactFormContent'])
    ...
    models = {
        ...
        'page.contactformcontent': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'ContactFormContent', 'db_table': "'page_page_contactformcontent'"},
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contactformcontent_set'", 'to': "orm['page.Page']"}),
