...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page._content_title'
        db.add_column('page_page', '_content_title',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Page._page_title'
        db.add_column('page_page', '_page_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page._content_title'
        db.delete_column('page_page', '_content_title')

        # Deleting field 'Page._page_title'
        db.delete_column('page_page', '_page_title')
