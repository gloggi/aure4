...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kurs.lagerbeitrag'
        db.add_column(u'anmeldung_kurs', 'lagerbeitrag',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=150),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Kurs.lagerbeitrag'
        db.delete_column(u'anmeldung_kurs', 'lagerbeitrag')
