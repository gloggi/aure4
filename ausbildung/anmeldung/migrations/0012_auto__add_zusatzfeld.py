...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Zusatzfeld'
        db.create_table('anmeldung_zusatzfeld', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kurs', self.gf('django.db.models.fields.related.ForeignKey')(related_name='zusatzfelder', to=orm['anmeldung.Kurs'])),
            ('typ', self.gf('ausbildung.anmeldung.fields.RequiredCharField')(max_length=100)),
            ('name', self.gf('ausbildung.anmeldung.fields.RequiredCharField')(max_length=100)),
        ))
        db.send_create_signal('anmeldung', ['Zusatzfeld'])


    def backwards(self, orm):
        # Deleting model 'Zusatzfeld'
        db.delete_table('anmeldung_zusatzfeld')
