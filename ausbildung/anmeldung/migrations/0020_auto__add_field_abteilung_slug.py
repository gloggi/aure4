...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Abteilung.slug'
        db.add_column('anmeldung_abteilung', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='migrated', unique_with=(), max_length=50, populate_from='name'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Abteilung.slug'
        db.delete_column('anmeldung_abteilung', 'slug')
