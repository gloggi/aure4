...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Anmeldung.user'
        db.add_column('anmeldung_anmeldung', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='anmeldungen', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Anmeldung.user'
        db.delete_column('anmeldung_anmeldung', 'user_id')
