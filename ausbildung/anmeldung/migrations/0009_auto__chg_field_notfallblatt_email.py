...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notfallblatt.email'
        db.alter_column('anmeldung_notfallblatt', 'email', self.gf('ausbildung.anmeldung.fields.OptionalCharField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Notfallblatt.email'
        raise RuntimeError("Cannot reverse this migration. 'Notfallblatt.email' and its values cannot be restored.")
