...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Anmeldung.foto'
        db.alter_column('anmeldung_anmeldung', 'foto', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Anmeldung.foto'
        db.alter_column('anmeldung_anmeldung', 'foto', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
