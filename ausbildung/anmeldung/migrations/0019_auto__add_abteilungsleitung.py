...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Abteilungsleitung'
        db.create_table('anmeldung_abteilungsleitung', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('abteilung', self.gf('django.db.models.fields.related.ForeignKey')(related_name='leiter', to=orm['anmeldung.Abteilung'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='al', to=orm['auth.User'])),
            ('seit', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
            ('bis', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('anmeldung', ['Abteilungsleitung'])


    def backwards(self, orm):
        # Deleting model 'Abteilungsleitung'
        db.delete_table('anmeldung_abteilungsleitung')


    models = {
        'anmeldung.abteilung': {
            'Meta': {'object_name': 'Abteilung'},
            'abteilungsleitung': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'through': "orm['anmeldung.Abteilungsleitung']", 'symmetrical': 'False'}),
