...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Abteilung.region'
        db.alter_column('anmeldung_abteilung', 'region', self.gf('ausbildung.anmeldung.fields.RequiredCharField')(default='Gloggi', max_length=100))

        # Changing field 'Abteilung.verband'
        db.alter_column('anmeldung_abteilung', 'verband', self.gf('ausbildung.anmeldung.fields.RequiredCharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Abteilung.region'
        db.alter_column('anmeldung_abteilung', 'region', self.gf('ausbildung.anmeldung.fields.OptionalCharField')(max_length=100, null=True))

        # Changing field 'Abteilung.verband'
        db.alter_column('anmeldung_abteilung', 'verband', self.gf('ausbildung.anmeldung.fields.OptionalCharField')(max_length=100, null=True))
