...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Anmeldung.erstellt'
        db.add_column('anmeldung_anmeldung', 'erstellt',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 12, 5, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Anmeldung.aktualisiert'
        db.add_column('anmeldung_anmeldung', 'aktualisiert',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 5, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Anmeldung.erstellt'
        db.delete_column('anmeldung_anmeldung', 'erstellt')

        # Deleting field 'Anmeldung.aktualisiert'
        db.delete_column('anmeldung_anmeldung', 'aktualisiert')
