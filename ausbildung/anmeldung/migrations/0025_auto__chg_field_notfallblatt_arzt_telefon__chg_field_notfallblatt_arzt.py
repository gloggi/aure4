...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notfallblatt.arzt_telefon'
        db.alter_column('anmeldung_notfallblatt', 'arzt_telefon', self.gf('ausbildung.anmeldung.fields.OptionalCharField')(max_length=100, null=True))

        # Changing field 'Notfallblatt.arzt_ort'
        db.alter_column('anmeldung_notfallblatt', 'arzt_ort', self.gf('ausbildung.anmeldung.fields.OptionalCharField')(max_length=100, null=True))

        # Changing field 'Notfallblatt.arzt_strasse'
        db.alter_column('anmeldung_notfallblatt', 'arzt_strasse', self.gf('ausbildung.anmeldung.fields.OptionalCharField')(max_length=100, null=True))

        # Changing field 'Notfallblatt.arzt_name'
        db.alter_column('anmeldung_notfallblatt', 'arzt_name', self.gf('ausbildung.anmeldung.fields.OptionalCharField')(max_length=100, null=True))

        # Changing field 'Notfallblatt.arzt_plz'
        db.alter_column('anmeldung_notfallblatt', 'arzt_plz', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Notfallblatt.arzt_telefon'
        raise RuntimeError("Cannot reverse this migration. 'Notfallblatt.arzt_telefon' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Notfallblatt.arzt_ort'
        raise RuntimeError("Cannot reverse this migration. 'Notfallblatt.arzt_ort' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Notfallblatt.arzt_strasse'
        raise RuntimeError("Cannot reverse this migration. 'Notfallblatt.arzt_strasse' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Notfallblatt.arzt_name'
        raise RuntimeError("Cannot reverse this migration. 'Notfallblatt.arzt_name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Notfallblatt.arzt_plz'
        raise RuntimeError("Cannot reverse this migration. 'Notfallblatt.arzt_plz' and its values cannot be restored.")
