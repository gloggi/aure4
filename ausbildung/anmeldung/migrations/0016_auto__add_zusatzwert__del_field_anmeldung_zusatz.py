...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Zusatzwert'
        db.create_table('anmeldung_zusatzwert', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('anmeldung', self.gf('django.db.models.fields.related.ForeignKey')(related_name='zusatz', to=orm['anmeldung.Anmeldung'])),
            ('name', self.gf('ausbildung.anmeldung.fields.RequiredCharField')(max_length=100)),
            ('wert', self.gf('ausbildung.anmeldung.fields.RequiredCharField')(max_length=100)),
        ))
        db.send_create_signal('anmeldung', ['Zusatzwert'])

        # Deleting field 'Anmeldung.zusatz'
        db.delete_column('anmeldung_anmeldung', 'zusatz')


    def backwards(self, orm):
        # Deleting model 'Zusatzwert'
        db.delete_table('anmeldung_zusatzwert')

        # Adding field 'Anmeldung.zusatz'
        db.add_column('anmeldung_anmeldung', 'zusatz',
                      self.gf('ausbildung.anmeldung.fields.JSONField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'anmeldung.zusatzwert': {
            'Meta': {'object_name': 'Zusatzwert'},
            'anmeldung': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'zusatz'", 'to': "orm['anmeldung.Anmeldung']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('ausbildung.anmeldung.fields.RequiredCharField', [], {'max_length': '100'}),
            'wert': ('ausbildung.anmeldung.fields.RequiredCharField', [], {'max_length': '100'})
        },
        'auth.group': {
