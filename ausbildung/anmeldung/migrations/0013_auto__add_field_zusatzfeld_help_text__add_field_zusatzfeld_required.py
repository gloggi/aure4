...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Zusatzfeld.help_text'
        db.add_column('anmeldung_zusatzfeld', 'help_text',
                      self.gf('ausbildung.anmeldung.fields.OptionalCharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Zusatzfeld.required'
        db.add_column('anmeldung_zusatzfeld', 'required',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Zusatzfeld.help_text'
        db.delete_column('anmeldung_zusatzfeld', 'help_text')

        # Deleting field 'Zusatzfeld.required'
        db.delete_column('anmeldung_zusatzfeld', 'required')
