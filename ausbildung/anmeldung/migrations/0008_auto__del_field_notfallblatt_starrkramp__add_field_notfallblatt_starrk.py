...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notfallblatt.starrkramp'
        db.delete_column('anmeldung_notfallblatt', 'starrkramp')

        # Adding field 'Notfallblatt.starrkrampf'
        db.add_column('anmeldung_notfallblatt', 'starrkrampf',
                      self.gf('ausbildung.anmeldung.fields.RequiredCharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Notfallblatt.starrkramp'
        raise RuntimeError("Cannot reverse this migration. 'Notfallblatt.starrkramp' and its values cannot be restored.")
        # Deleting field 'Notfallblatt.starrkrampf'
        db.delete_column('anmeldung_notfallblatt', 'starrkrampf')
