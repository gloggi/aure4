...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Zusatzfeld.name'
        db.delete_column('anmeldung_zusatzfeld', 'name')

        # Adding field 'Zusatzfeld.label'
        db.add_column('anmeldung_zusatzfeld', 'label',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Zusatzfeld.name'
        raise RuntimeError("Cannot reverse this migration. 'Zusatzfeld.name' and its values cannot be restored.")
        # Deleting field 'Zusatzfeld.label'
        db.delete_column('anmeldung_zusatzfeld', 'label')
