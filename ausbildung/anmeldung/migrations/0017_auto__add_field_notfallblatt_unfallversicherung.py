...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notfallblatt.unfallversicherung'
        db.add_column('anmeldung_notfallblatt', 'unfallversicherung',
                      self.gf('ausbildung.anmeldung.fields.RequiredCharField')(default='Keine Angabe', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notfallblatt.unfallversicherung'
        db.delete_column('anmeldung_notfallblatt', 'unfallversicherung')
