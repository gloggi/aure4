...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ALFeedback'
        db.create_table('anmeldung_alfeedback', (
            ...
            ('mitteilung', self.gf('django.db.models.fields.TextField')()),
            ('kontaktperson', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('mobiltelefon', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('anmeldung', ['ALFeedback'])


    def backwards(self, orm):
        # Deleting model 'ALFeedback'
        db.delete_table('anmeldung_alfeedback')
