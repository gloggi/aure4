...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Anmeldung.bezahlt'
        db.add_column('anmeldung_anmeldung', 'bezahlt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Anmeldung.bezahlt'
        db.delete_column('anmeldung_anmeldung', 'bezahlt')
    ...
    models = {
        ...
        'anmeldung.anmeldung': {
            ...
            'notfallblatt': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'seki': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
