...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Abteilung', fields ['slug']
        db.create_unique('anmeldung_abteilung', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Abteilung', fields ['slug']
        db.delete_unique('anmeldung_abteilung', ['slug'])
